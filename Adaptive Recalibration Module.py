...
# 新增
parser.add_argument('--train_file', type=str, help='path to training csv file', default='train.csv')
parser.add_argument('--test_file', type=str, help='path to testing csv file', default='test.csv')
...
# Training / Evaluation
# =========================
def main(episodes, trainsteps, updatesteps, batchsize, alpha, train_file, test_file):
