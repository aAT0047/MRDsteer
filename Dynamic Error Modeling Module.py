...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train on train.csv and predict RUL on test.csv")
    ...
    parser.add_argument("--output_rul_path", type=str, default="rul_predictions.csv", help="path to save RUL predictions")
    parser.add_argument("--output_lambda_path", type=str, default="test_lambda_paths.csv", help="path to save lambda paths")
    parser.add_argument("--failure_threshold", type=float, default=0.30, help="failure threshold")
    parser.add_argument("--R_meas", type=float, default=0.005**2, help="measurement noise variance")
    ...
    theta1, Q_lambda_est, df_test_filtered, df_rul = train_and_predict_rul(
        ...
        output_rul_path=args.output_rul_path,
        output_lambda_path=args.output_lambda_path,
